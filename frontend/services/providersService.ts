...
export const STREAMING_PROVIDERS = {
  ...
  hbo: { id: 384, name: 'HBO Max', logo: '/Ajqyt5aNxNGjmF9uOfxArGrdf3X.jpg' },
  ...
  showtime: { id: 37, name: 'Showtime', logo: '/Allse9kbjiP6ExaQrnSpIhkurEi.jpg' },
  starz: { id: 43, name: 'Starz', logo: '/8UKfr9pjuXXRCpO6lWIo4BqHY2U.jpg' },
  ...
  stan: { id: 21, name: 'Stan', logo: '/t8JnYFntJbzNdIKPLqzwTq7QKS7.jpg' },
  now: { id: 39, name: 'Now TV', logo: '/hOv4jVbF6w7yKJ4KP6DxAXIANTs.jpg' },
  skygo: { id: 29, name: 'Sky Go', logo: '/r3FH5KWETXb9p89r5prv8FHMeTH.jpg' },
  // Free services
