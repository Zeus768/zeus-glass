...
const styles = StyleSheet.create({
  ...
  heroContent: {
    ...
    paddingBottom: isTV ? 24 : 32,
  },
  heroInfo: {
    paddingHorizontal: isTV ? 40 : 24,
    maxWidth: isTV ? 650 : '100%',
  },
  trendingBadge: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  heroTitle: {
    ...
    lineHeight: isTV ? 42 : 48,
  },
  heroDescription: {
    fontSize: isTV ? 14 : 15,
    color: theme.colors.textSecondary,
    lineHeight: isTV ? 20 : 22,
    marginBottom: isTV ? 10 : 16,
  },
  channelBadge: {
    flexDirection: 'row',
    alignItems: 'center',
    marginBottom: isTV ? 12 : 20,
    gap: isTV ? 8 : 8,
  },
  channelText: {
    fontSize: isTV ? 13 : 14,
  ...
  ratingBox: {
    ...
    paddingHorizontal: isTV ? 8 : 8,
    paddingVertical: isTV ? 2 : 2,
    borderRadius: 4,
    borderWidth: 1,
  ...
  watchButton: {
    ...
    paddingHorizontal: isTV ? 24 : 28,
    paddingVertical: isTV ? 10 : 14,
    borderRadius: isTV ? 10 : 12,
    gap: isTV ? 8 : 8,
    borderWidth: 3,
